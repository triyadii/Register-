...
<head>
    <title>indaac2025sumut | Register.co.id</title>
    <meta charset="UTF-8">
...
<body>
    <div class="size1 bg0 where1-parent">
        <div class="flex-c-m bg-img1 size2 where1 overlay1 where2 respon2"
            style="background-image: url('assets_maintenance/images/backgroundMaintenance2.jpg');">
        </div>
        <div class="size3 flex-col-sb flex-w p-l-75 p-r-75 p-t-45 p-b-45 respon1">

            <div class="p-t-50 p-b-60">
                <h1>IndAAC Sumut 2025</h1>
                <hr>
                <p class="m1-txt1 p-b-36">
                    Selamat datang di pendaftaran <span class="m1-txt2"> IndAAC Sumut 2025 </span>, Pendaftaran Akan di
                    buka pada bulan Desember 2024
                </p>
            </div>
