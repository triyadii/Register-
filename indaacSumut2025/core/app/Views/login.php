...
<head>
    ...
    <title>IndAAC Sumut 2025 | Login</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Login Peserta</h5>
                                    ...
                                    <form method="POST" action="Login" enctype="multipart/form-data">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <p class="small mb-0">Belum Memiliki Akun ? <a
                                                    href="<?= base_url() ?>Registrasi">Silahkan Daftar Terlebih
                                                    Dahulu</a>
                                            </p>
                                            <p class="small mb-0">Operator ? <a
                                                    href="<?= base_url() ?>LoginOperator">Silahkan Login Operator</a>
                                            </p>
                                        </div>
                                </div>
                                </form>
